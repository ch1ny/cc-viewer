...
- Мобільний перегляд чату: у мобільному режимі CLI натисніть кнопку «Перегляд чату» на верхній панелі, щоб відкрити подання чату лише для читання та переглянути повну історію розмов на телефоні
