...
- تصفح المحادثة على الهاتف: في وضع CLI على الهاتف، اضغط على زر «تصفح المحادثة» في الشريط العلوي لعرض واجهة محادثة للقراءة فقط وتصفح سجل المحادثات الكامل على هاتفك
